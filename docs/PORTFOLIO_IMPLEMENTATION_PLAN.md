...
- Remove canvas, audio, certificate data, cursor effects, calculator, tilt, and mode-switching code
...
8. Verify production deployment after the approved Git push reaches `main`.
